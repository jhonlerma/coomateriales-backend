# Generated by Django 4.0.6 on 2022-08-03 21:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_usuario', models.CharField(max_length=40, verbose_name='Name')),
                ('apellido_usuario', models.CharField(max_length=40, verbose_name='LastName')),
                ('telefono_usuario', models.CharField(max_length=40, verbose_name='Phone')),
                ('correo_usuario', models.EmailField(max_length=256, verbose_name='Email')),
                ('direccion_usuario', models.CharField(max_length=60, verbose_name='Address')),
